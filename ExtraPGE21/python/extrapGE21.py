...
#  fileNames = cms.untracked.vstring('file:../../../gemsw/EventFilter/test/output2_edm.root'),
  fileNames = cms.untracked.vstring('file:/lustre/home/mmaggi/CMS/GEM/TB2021/Data/output_edm_track.root'),
                            labelRawDataLikeMC = cms.untracked.bool(False)

)

process.TFileService = cms.Service("TFileService", fileName = cms.string("tbGE21Analysis.root") )
