...
process.gemTrkAli = cms.EDAnalyzer('GEMRot',
                                   ...
                                   thetaCentral=cms.untracked.double(0.00),
                                   thetaRange=cms.untracked.double(0.04),
                                   thetaNPoints=cms.untracked.int32(21)
)

process.source = cms.Source("PoolSource",                           
  fileNames = cms.untracked.vstring('file:../../../gemsw/EventFilter/test/output_edm_track21.root'),
